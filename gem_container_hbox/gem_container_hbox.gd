...
func _ready():
	...
	var unlock_dict_store = utility.unlock_dict_store
	
	if unlock_dict_store["gem_storage_small"] == true:
		$gem_storage_small.show()
		
	if unlock_dict_store["gem_storage_med"] == true:
		$gem_storage_med.show()
		
	if unlock_dict_store["gem_storage_large"] == true:
